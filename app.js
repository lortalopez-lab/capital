...
async function loadProfile() {
  ...
  if (error) {
    ...
    return renderAuth(
      'login',
      'No se pudo cargar tu perfil. Verifica la configuración de la base de datos.'
    );
  }
  ...
  setApp(`
    <main class="auth">
      <section class="card auth-card">
        ...
        <p class="small">
          Control personal de aportaciones, devoluciones y rendimiento estimado.
        </p>
...
function renderDashboard() {
    ...
    <main class="wrap">
      ...
      <div class="toolbar">
        ...
        <div>
          <h1>Mi resumen</h1>
          <span class="small">
            Gestiona tus negocios y movimientos
          </span>
        </div>
            ...
            >
              ...
              <div class="toolbar">
                ...
                <div>
                  ...
                  <span class="small">
                    Ingresos y devoluciones acumulados
                    por fecha
                  </span>
                </div>
  ...
  document.getElementById('newBusiness').onclick =
    () => businessModal();
...
function chart(ms) {
  ...
  if (!ms.length) {
    ...
    return `
      <div class="chart-empty">
        Agrega movimientos para visualizar
  ...
  const pts = rows.map(m => {
    ...
    if (m.type === 'ingreso') {
      cumIn += Number(m.amount);
    } else {
      cumOut += Number(m.amount);
    }
  ...
  return `
    <div class="chart-wrap">
      ...
      >
        ...
        <polyline
          class="line income-line"
          points="${poly('ins')}"
        />

        <polyline
          class="line return-line"
          points="${poly('outs')}"
        />
  ...
  document.getElementById('modal').innerHTML = `
    ...
    <div class="modal">
      ...
      <section class="card">
        ...
        <h2>
          ${b ? 'Renombrar negocio' : 'Nuevo negocio'}
        </h2>
        ...
        <form id="businessForm">
          ...
          <div class="field">
            ...
            <input
              ...
              maxlength="80"
              value="${esc(b?.name || '')}"
              placeholder="Ej. Negocio principal"
              required
            >
  ...
  document.getElementById('modal').innerHTML = `
    ...
    <div class="modal">
      ...
      <section class="card">
        ...
        <h2>
          ${m ? 'Editar movimiento' : 'Nuevo movimiento'}
        </h2>
...
loadSession().catch(error => {
  ...
  renderAuth(
    'login',
    'No se pudo iniciar la aplicación. Revisa la conexión con Supabase.'
  );
});
